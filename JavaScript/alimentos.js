...
async function getAlimentos() {
  try {
    ...
    console.error("Error al obtener alimentos:", error);Swal.fire({
      icon: "error",
      title: "Error...",
      text: "Error al obtener los alimentos.",
      timer: 4000,
...
function pintarAlimentos(alimentos) {
  ...
  alimentos.forEach(alimento => {
    ...
    tdPrecio.textContent = `$${alimento.precio.toFixed(2)}`; // Aseguramos que el precio tenga dos decimales
